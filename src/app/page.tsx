...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-24 sm:space-y-36 pb-24 bg-[#F5F2ED]">
      {/* Hero Section */}
      <section className="relative bg-[#F5F2ED] text-slate-900 overflow-hidden pt-12 pb-20 sm:pb-28 border-b border-slate-100">
